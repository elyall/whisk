...
export PATH="/global/home/users/elyall/Code/WhiskerTracking/whisk/build:$PATH" # add whisk binaries to path
...
export PYTHONPATH="/global/home/users/elyall/Code/WhiskerTracking/:$PYTHONPATH" # add whisk python modules to path
